...
const happens = ['a giant bird', 'an old friend', 'your next lover', 'a job opportunity', 'an enemy', 'imminent danger', 'catacalismic disaster', 'a sense of invincibility', 'a supernatural event', 'a paranormal happening', 'your wildest desires', 'a crazy party'];
...
writeMessage = document.write('<p style="color: darkblue; text-align: center; font-family: cursive; font-size: 1.4em;">Hello Human, today you will feel ' + randFeeling() + '. You should expect ' + randModifier() + randThing() + ' and you might even happen upon ' + randHappens() + '. Come back tomorrow morning for another prediction about your day.</p>')
return writeMessage;
}
